<?php 
namespace Books\Components\Metabox;
use \Books\Utils;
...
class Metabox{
    ...
    public function metabox_register_style( $hook_suffix ){
        ...
        if( 'post.php' == $hook_suffix || 'post-new.php' == $hook_suffix ) {
            wp_enqueue_style( 'metabox-css', $this->utils->books_plugin_url('assets/css/metabox.css'), array(), BOOKS_VERSION );
            
            wp_enqueue_script( 'metabox_admin_js', $this->utils->books_plugin_url('assets/js/plugin.js'), [ 'jquery', 'jquery-ui-datepicker' ], BOOKS_VERSION);

            wp_enqueue_script( 'metabox_plugin_js', $this->utils->books_plugin_url('assets/js/script.js'), [ 'jquery', 'jquery-ui-datepicker' ], BOOKS_VERSION);
        }
    }
